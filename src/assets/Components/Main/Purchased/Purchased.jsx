...
const Purchased = ({ title }) => {
    ...
    //receive purchased
    const { purchased } = useContext(myContext)
    const { handleRemovePurchased } = useContext(myContext)
    return (
        <div className="container mx-auto">
            <div className="text-center bg-purple-500 text-white p-3 rounded-lg">
                ...
                <p className="mt-3 text-slate-100mt-3 w-[60%] mx-auto">A smart gadget purchase involves buying advanced electronic devices designed to simplify and enhance daily tasks through automation, connectivity, and intelligent features</p>
            ...
            <div className=" pb-32 my-10">
                <div className="flex items-center justify-between px-5">
                    ...
                    <div className="relative">
                        ...
                        <span className="absolute bg-purple-400 h-5 w-5 flex items-center justify-center rounded-full -right-4 -top-2 text-white">{purchased.length}</span>
                    </div>
                ...
                <div className=" w-[70%] mx-auto p-3 rounded-xl flex flex-col gap-4 mt-10">
                    {
                        purchased.map((item, idx) =>
                            <div key={idx} className="bg-gray-100 flex p-3 rounded-lg justify-between items-center max-sm:flex-col">
                                ...
                                <button onClick={() => handleRemovePurchased(item)} className="font-bold text-lg items-center justify-center flex gap-2 w-32 border border-purple-600 py-2 rounded-lg"><span>Remove</span><RiDeleteBin6Line /></button>
